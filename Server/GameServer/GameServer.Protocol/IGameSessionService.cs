...
public interface IGameSessionService
{
    ...
    Task<IReadOnlyList<PlayerPresenceDto>> ListLobbyPlayersAsync(CancellationToken cancellationToken);
    ...
    Task<GameStateDto?> TryGetMatchStateAsync(string gameId, CancellationToken cancellationToken);
